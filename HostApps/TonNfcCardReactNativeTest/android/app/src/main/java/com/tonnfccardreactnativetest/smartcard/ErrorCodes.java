...
public class ErrorCodes {
    ...
    public final static short SW_INCORRECT_PIN = (short) 0x9F01;
    public final static short SW_UPDATE_PIN_ERROR = (short) 0x9F02;
    public final static short SW_PIN_TRIES_EXPIRED = (short) 0x9F08;

    public final static short SW_LOAD_SEED_ERROR = (short) 0x9F03;
    ...
    public static String getMsg(RAPDU apduAnswer) {
        ...
        int sw = makeShort(swBytes, (short)0);
        return codeToMsg.get(sw);
    }

    public static String getMsg(String apduAnswer) {
        int sw = makeShort(bytes(apduAnswer.trim()), (short) 0);
