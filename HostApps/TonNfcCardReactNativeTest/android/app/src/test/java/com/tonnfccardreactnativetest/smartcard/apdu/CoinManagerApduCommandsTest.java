...
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.APDU_DATA_MAX_SIZE;
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.HMAC_SHA_SIG_SIZE;
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.INS_VERIFY_PASSWORD;
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.IV_SIZE;
...
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.SAULT_LENGTH;
import static com.tonnfccardreactnativetest.smartcard.TonWalletAppletConstants.WALLET_APPLET_CLA;
import static com.tonnfccardreactnativetest.smartcard.apdu.CoinManagerApduCommands.LABEL_LENGTH;
...
public class CoinManagerApduCommandsTest {
    ...
    public void initiateHmacHelper() throws Exception {
        ...
        when(hmacHelperMock.computeMac(any())).thenReturn(new byte[HMAC_SHA_SIG_SIZE]);
