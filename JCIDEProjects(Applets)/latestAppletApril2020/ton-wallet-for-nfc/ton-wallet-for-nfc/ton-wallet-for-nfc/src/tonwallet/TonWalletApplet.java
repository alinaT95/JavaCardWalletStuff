...
public class TonWalletApplet extends Applet
{
    ...
    private static final byte INS_SET_COMMON_SECRET  = (byte)0x94;
    ...
    private static final byte INS_GET_HASH_OF_COMMON_SECRET = (byte)0x95; 
            ...
            case Constants.APP_INSTALLED: {
                switch (ins) {
                    ...
                    case INS_GET_HASH_OF_ENCRYPTED_PASSWORD:
						...
						break;	
					case INS_SET_COMMON_SECRET:
						commonSecretHandler.setCommonSecret(apdu);
						break;
					case INS_GET_HASH_OF_COMMON_SECRET:
						commonSecretHandler.getHashOfCommonSecret(apdu);
						break;
