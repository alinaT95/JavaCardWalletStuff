...
public class SHA512 {
    ...
    private static final short[] H_INIT_SHORT={
    ...
    private static final short[] K_SHORT={
    ...
    private static short[] h_short;
    private static short[] w_short;

    private static short[] hashState;
    private static byte[] buffer;
    private static short bufferOff;
    private static short bufferLeft;
    ...
    private static void compressionFunction(short[] state, short stateOff, byte[] msgBlock, short msgOff){
